...
public class PersonaEntity {
    ...
    public PersonaEntity(Long id,String number, String juanCarlos, String garcía, String pérez, int i, String admin, Timestamp timestamp, TipoDocumentoEntity dni) {
    }
}
